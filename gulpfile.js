...
gulp.task('buildDist', ['cleanDist', 'html:buildAllPages', 'copyImgToDist', 'sassCompilationForDist', 'mergeCssLibs', 'createCustomModernizr', 'copyLibsScriptsToJs'], function () {
  ...
  gulp.src(['!src/js/temp/**/*.js', '!src/js/~*.js', '!src/js/**/_temp_*.js', '!src/js/common.js', 'src/js/*.js'])
      .pipe(gulp.dest(path.dist + '/js'));

  gulp.src('src/assets/**/*')
      .pipe(gulp.dest(path.dist + '/assets'));

  gulp.src(['!src/__*.html', '!src/all-pages.html', '!src/forms.html', '!src/typography.html', '!src/_tpl_*.html', '!src/_temp_*.html', 'src/*.html'])
